      ...
      <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: { xs: 1, sm: 2 } }}>
        <Box sx={{ display: 'flex', alignItems: 'center', gap: { xs: 1, sm: 1.5 } }}>
          ...
          <Box>
            ...
            <Typography sx={{ color: 'text.secondary', fontSize: { xs: '0.75rem', sm: '0.875rem', lg: '1rem' }, mt: 0.5, fontFamily: getFontFamily(language) }}>
        ...
        <Box sx={{ textAlign: 'end' }}>
          <Typography sx={{ color: 'grey.300', fontSize: { xs: '0.75rem', sm: '0.875rem', lg: '1rem' }, fontFamily: getFontFamily(language) }}>
